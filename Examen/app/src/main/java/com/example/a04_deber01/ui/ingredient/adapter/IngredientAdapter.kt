package com.example.a04_deber01.ui.ingredient.adapter
...
class IngredientAdapter(
    private val onDeleteClick: (Ingredient) -> Unit, // ✅ Now passing full Ingredient object
    ...
    inner class ViewHolder(private val binding: ItemIngredientBinding) :
        ...
        fun bind(ingredient: Ingredient) {
            ...
            binding.btnDelete.setOnClickListener {
                onDeleteClick(ingredient) // ✅ Pass full Ingredient object
            }
        }
    }
