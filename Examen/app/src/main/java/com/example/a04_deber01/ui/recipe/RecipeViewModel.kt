...
class RecipeViewModel(private val repository: RecipeRepository) : ViewModel() {
    ...
    fun updateRecipeLocation(recipeId: Int, latitude: Double, longitude: Double) = viewModelScope.launch {
        repository.updateRecipeLocation(recipeId, latitude, longitude) // ✅ Método para actualizar coordenadas
    }
